"""
Django settings for flashcard_gen_backend project.
...
SECRET_KEY = 'django-insecure-vgk%^@jy%sm3*dl#6fay8rc(jadv_o!(bnsj49c8ef9u%n#043'
...
AUTH_USER_MODEL = "flashcard_gen_api.CustomUser"
...
ROOT_URLCONF = 'flashcard_gen_backend.urls'
...
WSGI_APPLICATION = 'flashcard_gen_backend.wsgi.application'
